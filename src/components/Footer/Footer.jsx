    ...
    <div className="footer">
      ...
      <div className="footer-content">
        <div className="block-information">
          ...
          <Link to={"/"}>
            {" "}
            <p className="footer-link">Главная</p>
          </Link>
        ...
        <div className="block-information">
          ...
          <div className="buissnes-info">
            <p className="name">
              ...
              №690867884 от 21.08.2023.
            </p>
            <p className="adress">
              Логойским горисполкомом Защита прав потребителей +375259990755
            </p>
          </div>
        </div>
        <div className="block-information">
          ...
          <div className="social-networks">
            <img
              ...
              src="/src/assets/Image/group.svg"
              alt=""
            />
          </div>
          <div className="number">
            <img
              className="phone-img"
              src="/src/assets/Image/phone.svg"
              alt=""
            />
