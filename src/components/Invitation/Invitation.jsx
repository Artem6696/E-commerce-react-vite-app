    ...
    <div className='invitation'>
        <div className='invitation-box'>
            <div className='invitation-input'>
                <p className='title'>Приглашаем  к сотрудничеству производителей и поставщиков одежды, обуви и аксессуаров</p>
                <input className='input' placeholder='Ваше имя' type="text" />
                <input className='input' placeholder='Номер телефона' type="text" />
                <input className='input' placeholder='Электронная почта' type="text" />
                <div className='accept-data'>
                    <img className='circle' src="/src/assets/Image/circle.svg" alt="" />
                    <p className='accept'>Даю согласие на обработку персональных данных</p>
                </div>
