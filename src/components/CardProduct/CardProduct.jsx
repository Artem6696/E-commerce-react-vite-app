...
export const CardProduct = ({_id, name, photosURL, description, price, colors, sizes }) => {
   ...
   const isFavorite = useSelector((state) =>
    state.favorite.favoriteUser.some((item) => item._id === _id && item.isFavorite)
  );
    ...
    <div className="product-card" key={_id}>
        ...
        <div className="product-price">{price}KZT</div>
            ...
            <div className="product-actions">
                ...
                <svg  xmlns="http://www.w3.org/2000/svg" className="favorite" onClick={() => dispatch(addToFavorite({_id,  name, photosURL, colors, price, sizes }))} width="24" height="24" viewBox="0 0 18 18" fill="blue" >
